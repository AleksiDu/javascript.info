...
// Sometimes isFinite is used to validate whether a string is regular number:
num = +"10";
console.log("isFinite(num) =>", isFinite(num));
...
// There are situation when parseInt/parseFloat will return NaN. It happens whem mo digits could be read:
console.log("parseInt('a123') =>", parseInt('a123')); //NaN, the first symbol stops the process
console.log("parseFloat('.123') =>", parseInt('.123')); //NaN, the first symbol stops the process
 ...
 */
console.log(parseInt('0xff', 16)); //255, without 0x also works
...
console.log(Math.max(3, 4, -10, 0, 1)); //4
console.log(Math.min(1, 2)); //1

// Math.pow(n, power)
// Returns n raised to given power.
